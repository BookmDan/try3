...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'joins_join', ['email'])


    def backwards(self, orm):
        # Removing unique constraint on 'Join', fields ['email']
        db.delete_unique(u'joins_join', ['email'])

        # Adding field 'Join.ref_id'
        db.add_column(u'joins_join', 'ref_id',
                      self.gf('django.db.models.fields.CharField')(default='ABC', max_length=120, unique=True),
                      keep_default=False)
    ...
    models = {
        u'joins.join': {
            'Meta': {'unique_together': "(['email'],)", 'object_name': 'Join'},
